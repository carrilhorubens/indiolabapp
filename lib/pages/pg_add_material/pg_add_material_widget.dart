...
class PgAddMaterialWidget extends StatefulWidget {
  const PgAddMaterialWidget({
    Key? key,
    required this.passProduto,
  }) : super(key: key);

  final ProdutoViewRow? passProduto;
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                ...
                                                await MaterialTable().insert({
                                                  'mat_nome': _model
                                                      .matNomeController.text,
                                                  'mat_descricao': _model
                                                      .matDescricaoController
                                                      .text,
                                                  'mat_produto':
                                                      widget.passProduto?.proId,
                                                  'mat_marcacao': _model
                                                      .matMarcacaoController
                                                      .text,
                                                  'mat_valor': double.tryParse(
                                                      _model.matValorController
                                                          .text),
                                                  'mat_status': true,
                                                });
                        ...
                        Container(
                          ...
                          child: FutureBuilder<List<MaterialRow>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<MaterialRow> dataTableMaterialRowList =
                                  snapshot.data!;
                              return DataTable2(
                                columns: [
                                  DataColumn2(
                                ...
                                rows: dataTableMaterialRowList
                                    .mapIndexed((dataTableIndex,
                                        ...
                                        [
                                          Text(
                                            valueOrDefault<String>(
                                              dataTableMaterialRow.matCodigo
                                                  ?.toString(),
                                              '- - -',
                                            ),
                                            textAlign: TextAlign.start,
